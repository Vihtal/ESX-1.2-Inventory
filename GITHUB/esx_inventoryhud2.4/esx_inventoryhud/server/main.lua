...
PlayersBeingSearching = {}
PlayersSearching = {}
RegisterServerEvent('seconds-inventoryhud:openInventory')
AddEventHandler('seconds-inventoryhud:openInventory', function(targetId)
	local _source = source
	local targetXPlayer = ESX.GetPlayerFromId(targetId)
	TriggerClientEvent("esx_inventoryhud:openPlayerInventory", _source, targetId, targetXPlayer.name)
end)
...
RegisterServerEvent('seconds-inventoryhud:StopSearchingPlayer')
AddEventHandler('seconds-inventoryhud:StopSearchingPlayer', function(targetId)
	local _source = source
end)
